...
<head>
  ...
  <title>Sistem Informasi PSKS</title>
					...
					<div class="col-lg-3"></div>
						<div class="col-lg-6">
							...
							<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Logo_of_the_Ministry_of_Social_Affairs_of_the_Republic_of_Indonesia.svg/592px-Logo_of_the_Ministry_of_Social_Affairs_of_the_Republic_of_Indonesia.svg.png" class="mb-4" width="120px">							
								<h1 class="font-weight-semibold">REGISTER SIKS</h1>
								<div class="card-body">
									<form action="#">
										<fieldset class="mb-0">
											<div class="form-group">
												...
												<button type="button" class="btn btn-outline btn-lg alpha-primary text-primary"><a href="{{'loginn'}}">Sudah Punya Akun</a></button>
												<br><br>
