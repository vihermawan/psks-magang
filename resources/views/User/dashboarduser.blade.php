            ...
            <div class="col-xl-4 col-md-6">
              <div class="card border-left-success py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Diklat</div>
                      <div class="h2 mb-0 font-weight-bold text-gray-800">{{count($diklat)}}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card border-left-warning py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Keluarga</div>
                      <div class="h2 mb-0 font-weight-bold text-gray-800">{{count($keluargaterdamping)}}</div>
                    </div>
                    <div class="col-auto">
