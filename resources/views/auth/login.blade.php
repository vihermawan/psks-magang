				...
				<div class="row">
					<div class="col-lg-3"></div>
						<div class="col-lg-6">
                            ...
                            <center>	
							<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Logo_of_the_Ministry_of_Social_Affairs_of_the_Republic_of_Indonesia.svg/592px-Logo_of_the_Ministry_of_Social_Affairs_of_the_Republic_of_Indonesia.svg.png" class="mb-4" width="120px">							
                            </center>    
                                <h1 class="font-weight-semibold ">LOGIN PSKS</h1>
								<div class="card-body">
										...
										<fieldset class="mb-0">
											<div class="form-group">
												<div class="form-group form-group-feedback form-group-feedback-left">
													<input id="NikPSKS" type="text" class="form-control @error('NikPSKS') is-invalid @enderror" name="NikPSKS" value="{{ old('NikPSKS') }}" required autocomplete="NikPSKS" autofocus placeholder="NikPSKS">
												...
												<a href="{{ route('register') }}"><button type="button" class="btn btn-outline btn-lg alpha-primary text-primary">Buat Akun Baru</button></a>
												<br><br>
